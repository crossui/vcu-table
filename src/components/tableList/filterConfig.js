      ...
      <v-modal {...modalProps}>
        ...
        <div class="filter-content">
          <div class="filter-content-header">
            ...
            <v-button size={size} class="mr-10" onClick={handleSaveTpl} loading={this.saveLoading} icon="save"></v-button>
            <v-button size={size} class="mr-10" onClick={handleDelectTpl} loading={this.delectLoading} icon="delete"></v-button>
          </div>
