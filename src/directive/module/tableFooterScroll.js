...
const footerTbaleScroll = (el) => {
  let tableCount = el.getElementsByClassName('vcu-table-body').length;
  let tableDom1 = el.getElementsByClassName('vcu-table-body')[0];
  let tableDom2 = el.getElementsByClassName('vcu-table-body')[tableCount - 1];
